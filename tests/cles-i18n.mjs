...
import { COLONNES_RDV, TRIS_RDV } from "../src/lib/exporters.js";
...
function clesDynamiques() {
  ...
  // classements proposés pour les rendez-vous, traduits à l'affichage
  for (const tri of TRIS_RDV) cles.add(tri.label);
