...
/** Deux feuillets superposés : le geste « copier », lisible sans légende. */
      ...
      {ouvert && (
        <div className="mt-3 border-t border-slate-200 pt-3">
          ...
          {appel && (
            <Bouton
              variant="ghost"
              onClick={() => copieLigne(appel, t, flash)}
      ...
      <td className="py-1.5 pr-3 text-right whitespace-nowrap">
        ...
        {appel && (
          <button
            ...
            data-role="copier-ligne"
            aria-label={t("Copier la ligne Excel")}
            title={t("Copier les 23 colonnes de cet appel, pour les coller dans le fichier Excel")}
            className="ml-1 inline-flex items-center rounded-md border border-slate-300 px-2 py-[5px] text-slate-600 hover:border-teal-700 hover:text-teal-800"
          >
            <IconeCopier />
          </button>
        )}
